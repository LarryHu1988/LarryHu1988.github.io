...
const I18N = {
  'zh-Hans': {
    ...
    intro_zh_title: '滴水龙雨',
    intro_zh_body:
      '生于滴水沿，现居滴水湖。<br />生肖属龙，生时逢雨。<br />半导体行业从业十二年，<br />从产品工程到工艺整合。<br />追梅西，忠巴萨，念科比。<br />看读库，读新诗，写小诗。<br />踢实况，打黑猴，码APP。',
    quote_label: '今日诗句',
    card_poetry: '诗情雨意',
    card_apps: '数码雨饭',
    card_sports: '体育风雨',
  ...
  'zh-Hant': {
    ...
    intro_zh_title: '滴水龍雨',
    intro_zh_body:
      '生於滴水沿，現居滴水湖。<br />生肖屬龍，生時逢雨。<br />半導體行業從業十二年，<br />從產品工程到工藝整合。<br />追梅西，忠巴薩，念科比。<br />看讀庫，讀新詩，寫小詩。<br />踢實況，打黑猴，碼APP。',
    quote_label: '今日詩句',
    card_poetry: '詩情雨意',
    card_apps: '數碼雨飯',
    card_sports: '體育風雨',
